          ...
          builder: (BuildContext context, AnalyseAppStates state) {
            ...
            return Scaffold(
              appBar: AppBar(
                ...
                title: const Text("Players Tracking"),
                centerTitle: true,
                        ...
                        if (cubit.selectedVideo == null)
                          Column(
                            ...
                            children: const [
                              ...
                              Text(
                                "No Videos Yet, Please Select The Left Side Video",
                                style: TextStyle(
                                    color: Colors.grey,
                          ...
                          Column(
                            children: [
                              const Text('Left Side',style: TextStyle(color: Colors.brown,fontSize: 28),),
                              Padding(
                                ...
                                child: Container(
                                  ...
                                  child: TextButton(
                                      onPressed: () async {
                                        ...
                                        final res = cubit.postVideo(
                                            File(cubit.selectedVideo!.path),
                                            cubit.url1+ "/video_analyse1",
                                            context);
                                      },
                                      child: Row(
