...
class SecondVideoScreen extends StatelessWidget {
                ...
                child: SingleChildScrollView(
                  ...
                  child: Column(
                      ...
                      children: <Widget>[
                        if (cubit.selectedVideo == null)
                          Column(
                            ...
                            children: const [
                              ...
                              Text(
                                "No Videos Yet, Please Select The Middle Side Video",
                                style: TextStyle(
                                    color: Colors.grey,
                        ...
                        Column(
                            children: [
                              const Text('Middle Side',style: TextStyle(color: Colors.brown,fontSize: 28),),
                              Padding(
                                ...
                                child: Container(
                                  ...
                                  child: TextButton(
                                      onPressed: () async {
                                        ...
                                        final res = cubit.postVideo1(
                                            File(cubit.selectedVideo!.path),
                                            cubit.url1 + "/video_analyse2",
                                            context);
                                      },
                                      child: Row(
                                          ...
                                          children: const [
                                            ...
                                            Icon(Icons.upload_file_outlined,size: 30,color: Colors.white,)
                                          ])),
                                ),
                              ),
                              Padding(
